    ...
    htmlString += `
        <div class="car-card">
            <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                ${regionBadge}
                <button onclick="deleteCar(${car.id})" class="btn-delete-card" title="Удалить">✕ Удалить</button>
            </div>
            <h2>${safeName}</h2>
            <div class="car-specs">
                <span>📅 ${yearText}</span>
            ...
            <div class="rating-container">
                ...
                <div class="rating-scale-bg">
                    <div class="rating-scale-fill ${ratingColorClass.replace('rating-', 'bg-')}" 
            ...
            <button onclick="toggleCompare(${car.id})" 
                ...
                ${isComparing ? '✅ В сравнении' : '⚖️ Сравнить модель'}
            </button>
        </div>`;
});
